...
This page describes `legacy/apps/tiamat`, a previous HTTP service. What you deploy for HTTP now is [`api`](./api). Meter commands go through [`nxt-device-messaging`](../nxt-device-messaging), not an in-process queue in this app.
:::
