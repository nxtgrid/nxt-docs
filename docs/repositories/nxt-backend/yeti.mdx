...
This page describes `legacy/apps/yeti` (telemetry collectors). Collectors belong on [`worker`](./worker) when production monitoring is moved over. Do not run this app and `worker` against the same schedules at once.
:::
